''' Function to assess the steady states values of the variables, given the output of the identification'''

def Steady_States_Assessment(y_in, k, kd, alfa, mu_max, Ks, KI2, KH, Pt, kLa, D, N_bac, N_S1):
    
    [S1_in, S2_in, C_in, Z_in, XT_in] = y_in
    mu1_SS = alfa*D + kd[0]
    mu2_SS = alfa*D + kd[1]
