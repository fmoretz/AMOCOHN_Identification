...
w point pt 4 lc rgb "red", "kinetics_hyd.txt" using 1:3 title "mod" \
...
w point pt 4 lc rgb "red", "kinetics_k1.txt" using 1:3 title "mod" \
w lp pt point lc colour
...
w point pt 4 lc rgb "red", "kinetics_k6.txt" using 1:3 title "mod" \
w lp pt point lc colour
...
set xtic -1.7, 0.17, 0.55
plot "kinetics_kLa.txt" using 1:2 title "exp" \
w point pt 4 lc rgb "red", "kinetics_kLa.txt" using 1:3 title "mod" \
w lp pt point lc colour
...
w point pt 4 lc rgb "red", "kinetics_k4k1_k5k6_1.txt" using 1:3 title "mod" \
w lp pt point lc colour
...
w point pt 4 lc rgb "red", "kinetics_k4k1_k5k6_2.txt" using 1:3 title "mod" \
w lp pt point lc colour
...
w point pt 4 lc rgb "red", "kinetics_k6k3_k2k1_1.txt" using 1:3 title "mod" \
w lp pt point lc colour
...
w point pt 4 lc rgb "red", "kinetics_k6k3_k2k1_2.txt" using 1:3 title "mod" \
w lp pt point lc colour
...
w point pt 4 lc rgb "red", "kinetics_S1_1.txt" using 1:3 title "mod" \
w lp pt point lc colour
...
w point pt 4 lc rgb "red", "kinetics_S1_2.txt" using 1:3 title "mod" \
w lp pt point lc colour
